...
import './Skills.css';
import {Card, Header, Icon, Progress, Rating, Table} from 'semantic-ui-react'
    ...
    render() {
        return (
            <React.Fragment>
                ...
                <Header as='h3' className={this.props.inputClassName}><Icon name='terminal'/> Skills</Header>
                                ...
                                <Table.Body>
                                    {
                                        skill.items.map((item, i) =>
                                            <Table.Row key={i}>
                                                ...
                                                <Table.Cell>
                                                    {skill.type === 'rating' ?
                                                        <Rating defaultRating={item['value']} maxRating={6}
                                                                size='huge'
                                                                className={`color--${this.getRatingColor(item['value'])}`}/>
                                                        :
                                                        <Progress percent={item['value']}
                                                                  size='medium'
                                                                  color={this.getPercentageColor(item['value'])}
                                                                  progress/>
                                                    }
                                                </Table.Cell>
                                            </Table.Row>
